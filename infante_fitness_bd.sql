...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Jun-2025 às 14:06
...
--
-- Banco de dados: `infante_fitness_bd`
--
...
(1, '<p><span aria-label=\"Ligar para o n&uacute;mero de telefone 911 056 935\">+ 351 911 056 935</span></p>', '<p>Av.Escritor Costa Barreto 3000, 4420-445 Valbom</p>', '<p>infante.fitness@gmail.com</p>', '<p>https://www.facebook.com/?locale=pt_PT</p>');
...
(8, 'TESTE', '<p>oiuhgyfvhjkihug</p>', 'http://localhost/construcao_e_habitacao/uploads/logo_extraido.png', 'http://localhost/construcao_e_habitacao/uploads/logo_extraido.png', 'http://localhost/construcao_e_habitacao/uploads/logo_extraido.png', 'http://localhost/construcao_e_habitacao/uploads/logo_extraido.png');

-- --------------------------------------------------------

--
-- Estrutura da tabela `infante_people`
--

CREATE TABLE `infante_people` (
  `id` int(11) NOT NULL,
  `título` varchar(500) NOT NULL,
  `texto` longtext NOT NULL,
  `imagem` varchar(1000) NOT NULL
...
--
-- Índices para tabela `infante_people`
--
ALTER TABLE `infante_people`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `infante_people`
--
ALTER TABLE `infante_people`
