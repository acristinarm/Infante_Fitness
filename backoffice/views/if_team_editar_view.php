...
if($form){
    ...
    iduSQL("UPDATE if_team SET texto='$texto', tempo='$tempo', descricao='$descricao', pessoas='$pessoas'");
    header("Location: if_team.php");
}
    ...
    <main class="conatiner my-5 text-center">
        ...
        <div class="row mx-0 mt-4">
            <form class="col-12">
                ...
                <textarea name="texto" id="texto" ><?= $team["texto"]; ?></textarea>
                ...
                <select name="tempo" id="tempo">
                    <?php
                    for ($i = 10; $i <= 90; $i += 5) {
                        $selected = ($team["tempo"] == $i) ? "selected" : "";
                ...
                <textarea name="descricao" id="descricao" ><?= $team["descricao"]; ?></textarea>
                ...
                <select name="pessoas" id="pessoas">
                    <?php
                    for ($i = 5; $i <= 30; $i += 1) {
                        $selected = ($team["pessoas"] == $i) ? "selected" : "";
